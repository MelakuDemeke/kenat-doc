...
import { FaHammer, FaRulerCombined, FaPuzzlePiece, FaTools } from 'react-icons/fa'
...
>
  ...
  <Tabs.Tab><FaTools className="inline-block mr-2" /> PHP version coming soon...</Tabs.Tab>
</Tabs>
